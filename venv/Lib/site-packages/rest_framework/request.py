...
def wrap_attributeerrors():
    """
    Used to re-raise AttributeErrors caught during backend, preventing
...
class ForcedAuthentication:
    """
    This backend class is used if the test client or request factory
...
class Request:
    ...
    def user(self):
        ...
        by the backend classes provided to the request.
        """
    ...
    def auth(self):
        """
        Returns any non-user backend information associated with the
        request, such as an backend token.
        """
    ...
    def auth(self, value):
        """
        Sets any non-user backend information associated with the
        request, such as an backend token.
        """
        self._auth = value
    ...
    def successful_authenticator(self):
        """
        Return the instance of the backend instance class that was used
    ...
    def _authenticate(self):
        """
        Attempt to authenticate the request using each backend instance
        in turn.
        """
