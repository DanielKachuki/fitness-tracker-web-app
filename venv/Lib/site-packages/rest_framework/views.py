...
class APIView(View):
    ...
    def as_view(cls, **initkwargs):
        ...
        # Note: session based backend is explicitly CSRF validated,
        # all other backend is CSRF exempt.
    ...
    def perform_authentication(self, request):
        """
        Perform backend on the incoming request.

        Note that if you override this and simply 'pass', then backend
