...
$(function () {
  var $selectedAuthentication = $('#selected-backend')
  ...
  $('form.backend-token-form').submit(function (event) {
    event.preventDefault()
    var $form = $(this).closest('form')
  ...
  $('form.backend-basic-form').submit(function (event) {
    event.preventDefault()
    var $form = $(this).closest('form')
  ...
  $('form.backend-session-form').submit(function (event) {
    event.preventDefault()
    window.auth = {
      'type': 'session'
    }
